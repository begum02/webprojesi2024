...
// Rating GET endpoint
const getEbookRatings = async (req, res) => {
    ...
    try {
        const { data, error } = await supabase
            .from('ebook_rating')  // Changed from 'rating' to 'ebook_rating'
...
const postEbookRating = async (req, res) => {
...
const getAudiobookRatings = async (req, res) => {
    const { bookId } = req.params;
...
const postAudiobookRating = async (req, res) => {
    const { bookId, userId, score } = req.body;
